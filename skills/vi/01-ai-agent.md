...
| `langfuse` | LLM observability | [SPEC] |
| `crewai` | CrewAI multi-agent | [SPEC] |
| `claude-api` | Anthropic Claude API/SDK | [CORE] |
| `claude-code-guide` | Claude Code CLI guide | [CORE] |
| `claude-code-expert` | Claude Code expert | [SPEC] |
| `gemini-api-dev` | Google Gemini API | [SPEC] |
| `gemini-api-integration` | Gemini integration | [SPEC] |
| `copilot-sdk` | GitHub Copilot SDK | [SPEC] |
| `pydantic-ai` | Pydantic AI agents | [SPEC] |
...
| `hierarchical-agent-memory` | CLAUDE.md memory system | [SPEC] |
| `data-structure-protocol` | Structural memory codebase | [SPEC] |
